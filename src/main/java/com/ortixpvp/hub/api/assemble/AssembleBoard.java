package com.ortixpvp.hub.api.assemble;

import com.ortixpvp.hub.api.assemble.events.AssembleBoardCreatedEvent;
...
public class AssembleBoard {
	 ...
	 * Assemble Board.
	 *
	 * @param player that the scoreboard belongs to.
	 ...
	 *
	 * @param player who's scoreboard to setup.
	 */
	...
	/**
	 * Get the scoreboard entry at a specific position.
	 *
